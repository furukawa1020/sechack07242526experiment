...
2026-07-21にcommit `b6e9fba6c1c005a8286f118850aebf4495881815`を配信し、許可ファイル一覧とSHA-256、配信commit、全5経路のHTTP 200、実ブラウザ描画、同一ブラウザ内の表示同期、模擬装置操作を確認した。この実測中の外部originへのリクエストとWebSocketはともに0件だった。
